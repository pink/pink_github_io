...
;(function(window) {
	...
	var colorReveal = {
				"rgb(29, 106, 232)" : "#10459c",
				 "rgb(252, 67, 73)" : "#b1151a",
				 "rgb(200, 2, 255)" : "#79009a",
				 "rgb(164, 180, 184)" : "#6F7A7D",
				 "rgb(150, 206, 180)" : "#79a791"
	};
	...
	Revealer.prototype._addLayers = function() {
		...
		var  strHTML = '';
		for(var i = 0; i < 1; ++i) {
			var bgcolor = colorReveal[$('.page--current')[0].style["backgroundColor"]];
	...
	Revealer.prototype.reveal = function(direction, callbacktime, callback) {
		var bgcolor = colorReveal[$('.page--current')[0].style["backgroundColor"]];
		$('.revealer__layer')[0].style["background"] = bgcolor;
		// if animating return
		if( this.isAnimating ) {
			return false;
		}
